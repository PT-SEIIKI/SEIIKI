...
export default function GallerySection() {
  ...
  return (
    <section
      id="gallery"
      className="py-16 w-full md:py-24 bg-gradient-to-b from-background via-secondary/5 to-background relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Dokumentasi kegiatan inspeksi, pengujian, dan operasional SEIIKI
            dengan standar profesional tertinggi.
          </p>
        </motion.div>
      </div>

      <div className="mt-12 relative gallery-wrapper">
        ...
        >
          <div className="gallery-track gallery-track-right gap-6 will-change-transform">
            {tripled.map((item, i) => (
              <motion.div
                key={`top-${i}`}
        ...
        >
          <div className="gallery-track gallery-track-left gap-6 will-change-transform">
            {tripled.map((item, i) => (
              <motion.div
                key={`bottom-${i}`}
                className="shrink-0 w-[280px] sm:w-[320px] md:w-[380px]"
