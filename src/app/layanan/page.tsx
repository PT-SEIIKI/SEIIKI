...
import { Loader2, MapPin, Navigation, CheckCircle, LogIn, UserPlus, X, ShieldCheck, RefreshCw } from 'lucide-react';
      ...
      >
        ...
        <div className="px-6 py-5 space-y-3">
          <Button
            ...
            style={{ background: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)' }}
            onClick={() => router.push('/login?redirect=/layanan')}
          >
          ...
          <Button
            ...
            onClick={() => router.push('/register?redirect=/layanan')}
          >
...
export default function LayananPage() {
  ...
  const getLocation = useCallback(() => {
    ...
    // Coba dulu dengan high accuracy, jika timeout fallback ke low accuracy
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (err) => {
          if (err.code === 3 && highAccuracy) {
            // Timeout dengan high accuracy → coba lagi dengan low accuracy
